        ...
        <>
            <div className={styles.hero}>
                <div className={styles['hero-content']}>
                    ...
                    <a href="/FrontEnd/login/login.html" className={styles['cta-button']}>Join Now</a>
                </div>
            </div>
            ...
            <section className={styles['cta-section']}>
                ...
                <div className={styles['cta-content']}>
                    ...
                    <a href="/FrontEnd/login/login.html" className={styles["large-cta-button"]}>Sign Up Now</a>
